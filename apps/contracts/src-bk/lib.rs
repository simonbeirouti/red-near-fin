...
use near_sdk::{
    env, near_bindgen, require, AccountId, BorshStorageKey, CryptoHash, NearSchema, NearToken,
...
impl Contract {
    ...
    */
    ...
    pub fn new(owner_id: AccountId, metadata: NFTContractMetadata) -> Self {
        ...
        let mut approved_minters = LookupSet::new(StorageKey::ApprovedMinters);
        approved_minters.insert(&owner_id);

        // Create the approved creators set and insert the owner
        let mut approved_creators = LookupSet::new(StorageKey::ApprovedCreators);
